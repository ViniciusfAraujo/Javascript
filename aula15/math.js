...
let num2 = Math.floor(num2) //arredonda numero para baixo
let num3 = Math.ceil(num3)  //arredonda o numero para cima
let num4 = Math.round(num4) //50 pra cima arredonda o numero pra cima, 49 arredonda pra baixo
